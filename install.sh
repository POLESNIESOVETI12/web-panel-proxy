#!/usr/bin/env bash
# Public one-command bootstrapper for WEB PANEL PROXY V 2.3.6.
set -Eeuo pipefail
umask 077
...
RELEASE_REF="${WEB_PANEL_PROXY_REF:-v2.3.6}"
...
echo "WEB PANEL PROXY V 2.3.6 — downloading installation files..."
